...
class TestCategoria(unittest.TestCase):
    ...
    # El id de la categoria a modificar existe en la base de datos. El nuevo 
    #          nombre es de largo 100.
    def testModificarCategoriaIdExistNewDescripLen100(self):
        self.vaciarBaseDeDatos() # Se limpia la base de datos.
    ...
    # El nuevo nombre para la Categoria a modificar es tamaño 100 y id MAX . 
    def testModificarCategoriaIdMaxDescripLen100(self):  
        self.vaciarBaseDeDatos() # Se limpia la base de datos. 
